...
g++-13 -o Lampenproblem Lampenproblem.cpp -lgmp -lgmpxx -lflint -lncursesw -DNCURSES_WIDECHAR=1 -O2 -march=native || g++-13 -o Lampenproblem Lampenproblem.cpp -lgmp -lgmpxx -lncursesw -DNCURSES_WIDECHAR=1 -O2 -march=native || g++-14 -o Lampenproblem Lampenproblem.cpp -lgmp -lgmpxx -lncursesw -DNCURSES_WIDECHAR=1 -O2 -march=native

#cp -v Lampenproblem ./IDA/
strip Lampenproblem || echo 'the "strip" command is not installed lmao'
cp -v Lampenproblem ./testumgebung/
cp -v onlinestatus.sh ./testumgebung/
